...
## Purpose
List, preview, download, and delete **any** object in the Backblaze B2 bucket —
the full-bucket explorer. For a view scoped to just this app's archive prefix,
grouped by camera and date, see the [Archive Library](archive-library.md).
